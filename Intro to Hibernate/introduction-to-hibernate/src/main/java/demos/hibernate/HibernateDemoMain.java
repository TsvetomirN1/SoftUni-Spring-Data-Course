...
//                session.detach(student);
//                session.persist(student);
// throws: org.hibernate.PersistentObjectException: detached entity passed to persist: demos.hibernate.model.Student
...
//
            ...
            criteria.select(r).where(builder.like(r.get("name"),"Ivan%"));
