...
public class GlobalConstants {
    ...
    public static final String PASSENGERS_FILE_PATH =
            "src/main/resources/files/json/passengers.json";

    public static final String TOWN_FILE_PATH =
            "src/main/resources/files/json/towns.json";

    public static final String PLANES_FILE_PATH =
            "src/main/resources/files/xml/planes.xml";

    public static final String TICKETS_FILE_PATH =
